...
ഹായ് , ഞാൻ Movie House ഗ്രൂപ്പിന് വേണ്ടി നിർമിച്ച ഒരു കിടിലൻ Admin bot ആണ്. എനിക്ക് എന്തൊക്കെ ചെയ്യാൻ പറ്റും എന്ന് അറിയാൻ /help അമർതൂ
"""
            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="🎉 Add me to your group", url="t.me/{}?startgroup=true".format(bot.username)),  InlineKeyboardButton(text="🤖 Make Own Admin Bot", url="https://youtu.be/W6CLKrehy6w")],
                     [InlineKeyboardButton(text="👥 Movie Group", url="https://t.me/movieshub10"), InlineKeyboardButton(text="🔔 Update Channel", url="https://t.me/KochuUpdates")],
                     [InlineKeyboardButton(text="🎬 Main Channel", url="https://t.me/moviehousegf2"), InlineKeyboardButton(text="🛠 Help", url="https://t.me/{}?start=help".format(bot.username)) ]]))

    else:
        update.effective_message.reply_text("I am still alive...")
